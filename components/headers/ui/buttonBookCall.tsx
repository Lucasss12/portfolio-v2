...
export default function buttonBookCall({ children }: ButtonBookCallProps) {
  return (
   <button className="group relative inline-flex items-center justify-center overflow-hidden rounded-md bg-gradient-to-t from-emerald-400 to-emerald-500 px-6 py-3 font-medium text-white">
