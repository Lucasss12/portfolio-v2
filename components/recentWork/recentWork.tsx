  ...
  return (
    <div className="sm:mt-20 mt-12">
      <div className="flex justify-between items-center mb-4">
        ...
        <Link href="/projets" className="flex items-center py-1 px-2 rounded-md bg-mainBg bg-opacity-80 text-sm hover:-translate-y-1 transform transition duration-200">
          Mes autres projets
